...
public class AxisAppState extends BaseAppState implements ActionListener {
    ...
    public AxisAppState(float length) {
    ...
    protected void initialize(Application app) {
        ...
        // 坐标
        createArrow("X", Vector3f.UNIT_X.mult(length), ColorRGBA.Red);
        createArrow("Y", Vector3f.UNIT_Y.mult(length), ColorRGBA.Green);
        createArrow("Z", Vector3f.UNIT_Z.mult(length), ColorRGBA.Blue);
